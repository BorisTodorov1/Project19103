...
class Category(db.Model):
    ...
    product_relationship = db.relationship('Product', backref=db.backref('category', lazy=True))
...
class Product(db.Model):
    ...
    category_id = db.Column(db.Integer, db.ForeignKey('category.id'))
    category_relationship = db.relationship('Category', backref=db.backref('products', lazy=True))
